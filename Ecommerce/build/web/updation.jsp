<%-- 
    Document   : updation
    Created on : 16 Jan, 2018, 11:30:43 AM
    Author     : welcome
--%>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="logout.jsp">Logout</a></li>
        ...
        <h1>Update any item</h1>
        
      <form id= "formid" name="cartform" action="inventoryupdate.jsp" method="POST">
           <table class="table-bordered" border="0">
                <tbody>
                    <tr>
                        
                         <div class="form-group">
      <label for="inputsm"> Item id of the item to be updated: </label>
