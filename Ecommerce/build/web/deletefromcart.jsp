<%-- 
    ...
    Created on : 12 Jan, 2018, 11:07:13 PM
    Author     : welcome
--%>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="logout.jsp">Logout</a></li>
        ...
        <center>
        <h1>DELETE AN ITEM FROM CART</h1>
        <form id= "formid" name="cartform" action="deletecart.jsp" method="POST">
            <table border="0">
                <tbody>
                    <tr>
                          <div class="form-group">
      <label for="inputsm"> Enter the item id: </label>
      <input class="form-control input-sm" name="itemid" type="text" value="<%=request.getParameter("param1")%>">
                    ...
                    <tr>
                        <div class="form-group">
      <label for="inputsm"> Enter the count you want to remove: </label>
      <input class="form-control input-sm" name="count" type="text" value="">
                        </div>
                    </tr>
                </tbody>
            </table>
               <center><input id="button" type="submit" value="delete from cart" /></center>
        </form></center>
